# Classic Snake: diagnosing Jev, improving the controller, and testing the limits
...
For 16/16 observed game successes, the descriptive Wilson 95% interval is **80.6%–100.0%**. The 1,061 moves are dependent observations within those games, not 1,061 independent full-game trials. No finite sample proves universal 100%.

Longer games exposed planner limits. The original exact planner completed **6/16** code-only 24-food games. A bounded-search repair improved that to **14/16** on the same development seeds, and completed **15/16** on new held-out long-game seeds. The remaining failures are retained. The predeclared gate for a new long-game Jev test was not met, so that test was not run. Long-game code results must not be described as Jev results.
...
|---|---:|---:|---:|
| Direct | 613/616 | 414/616 | 616/616 |
| Guarded | 1001/1001 | 645/1001 | 1001/1001 |
...
|---|---:|---:|---:|---:|
| original | 44/60 | 41/60 | 55.8%–78.7% | 59/60 |
| compact | 41/60 | 45/60 | 62.8%–84.2% | 60/60 |
| absolute | 40/60 | 48/60 | 68.2%–88.2% | 60/60 |
| local | 57/60 | 57/60 | 86.3%–98.3% | 60/60 |
| exact | 60/60 | 60/60 | 94.0%–100.0% | 60/60 |
...
|---|---:|---:|---:|---:|
| unassisted | 0/16 | 967/1515 (63.8%) | 17/55 | 0 |
| assisted | 16/16 | 1061/1061 (100.0%) | 128/128 | 0 |
| verified | 16/16 | 1061/1061 (100.0%) | 128/128 | 0 |
| oracle | 16/16 | 0/0 (no model) | 128/128 | 0 |

The original-prompt endings were {"body_collision": 1, "no_food_limit": 6, "step_limit": 2, "wall_collision": 7}. Both assisted profiles and code-only planner ended at the target in every paired game. The two assisted profiles can share successful trajectories because their inputs and decisions can coincide; they are not independent proof replications across distinct task distributions.
