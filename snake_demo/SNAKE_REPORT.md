# Jev plays Snake: what actually happened
...
responses returned `jev-1.13.0`. There were 4,515 successful
...
| Difficulty | Direct: mean / best / target successes | Guarded: mean / best / target successes | Baseline: mean / best / target successes |
|---|---:|---:|---:|
| Open | 1.75 / 6 / 0/8 | 3.75 / 8 / 2/8 | 8.00 / 8 / 8/8 |
| Classic | 3.38 / 5 / 0/8 | 4.88 / 8 / 1/8 | 8.00 / 8 / 8/8 |
| Obstacles | 1.75 / 6 / 0/8 | 1.50 / 3 / 0/8 | 7.50 / 8 / 7/8 |
| Dense | 0.25 / 1 / 0/8 | 0.62 / 1 / 0/8 | 5.62 / 8 / 4/8 |
...
| Selected board | Guarded Jev food / moves | Baseline food / moves |
|---|---:|---:|
| Open, seed 103 | 4 / 136 | 24 / 140 |
| Open, seed 104 | 1 / 57 | 12 / 68 |
| Classic, seed 104 | 2 / 66 | 24 / 215 |
...
| Difficulty / profile | Successful API calls | Mean input / call | Mean output / call | Median latency | P95 latency | Forced safe moves |
|---|---:|---:|---:|---:|---:|---:|
| Open / Jev direct | 627 | 602.18 | 38.00 | 335 ms | 483 ms | 0 |
| Open / Jev guarded | 755 | 604.79 | 37.95 | 335 ms | 508 ms | 2 |
| Classic / Jev direct | 616 | 603.46 | 38.00 | 336 ms | 514 ms | 0 |
| Classic / Jev guarded | 1001 | 596.69 | 35.24 | 338 ms | 503 ms | 29 |
| Obstacles / Jev direct | 571 | 676.97 | 38.00 | 335 ms | 505 ms | 0 |
| Obstacles / Jev guarded | 542 | 659.80 | 34.42 | 335 ms | 488 ms | 72 |
| Dense / Jev direct | 130 | 742.82 | 38.00 | 345 ms | 873 ms | 0 |
| Dense / Jev guarded | 273 | 728.68 | 34.38 | 339 ms | 566 ms | 49 |
...
[Exact main per-decision usage](records/20260917T013832Z-benchmark/per_decision_usage.csv) ·
[Endurance usage](records/20260917T014718Z-endurance/per_decision_usage.csv) ·
[Pilot usage](records/20260917T013629Z-pilot/per_decision_usage.csv)

The main run reported **2,842,863 input / 165,844
output tokens** on successful calls. The selected endurance run reported
**155,909 input / 9,758 output tokens**.
...
Evidence directories: [pilot](records/20260917T013629Z-pilot/),
[main](records/20260917T013832Z-benchmark/), [endurance](records/20260917T014718Z-endurance/).
